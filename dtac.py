...
PROXT_ADDR = '10.4.4.4'
PROXY_PORT = 8080
PAYLOAD = 'CONNECT [host_port] [protocol][crlf]Host: static.line.naver.jp[crlf]X-Online-Host: static.line.naver.jp[crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf]CONNECT [host_port] [protocol][crlf][crlf]'
