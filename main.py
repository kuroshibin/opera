...
class Server:
    ...
    def show(self):
        sys.stderr.write(self.about('\n\n-Info: Simple server successfully loaded! \n-Warning: Do not try to do any modification!\n\n\n[ About: ]------------------------------'))
        time.sleep(1)
        sys.stderr.write(self.config('Configuration'))
        time.sleep(2)
        sys.stderr.write(self.log('========Script Running======== \nDo not try to do any modification!\nVisit http://eyecodec.com for more details.\nReading Servers:============================='))
